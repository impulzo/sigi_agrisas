...
function toTaxRate(dto: TaxRateDto): TaxRate {
  return {
    ...
    satTaxCode: dto.satTaxCode,
    factorType: dto.factorType,
    displayValue: dto.displayValue,
    rate: dto.rate,
    transferredAccount: dto.transferredAccount,
    pendingTransferredAccount: dto.pendingTransferredAccount,
    creditedAccount: dto.creditedAccount,
    pendingCreditedAccount: dto.pendingCreditedAccount,
