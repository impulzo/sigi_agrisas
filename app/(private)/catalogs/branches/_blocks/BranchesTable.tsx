      ...
      <table className="w-full text-body-md">
        <thead>
          <tr className="border-b border-outline-variant bg-surface-container">
            ...
            <th className="text-left px-4 py-3 text-label-lg text-on-surface-variant font-medium">Dirección</th>
            <th className="text-left px-4 py-3 text-label-lg text-on-surface-variant font-medium">Teléfono</th>
