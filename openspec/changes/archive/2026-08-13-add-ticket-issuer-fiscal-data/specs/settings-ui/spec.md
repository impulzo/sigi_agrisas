...
- **THEN** the page allows uploading/deleting the logo, editing razón social, RFC, business address/phone/tax regime, header/footer text, and changing the paper width, persisting changes via `settings-api`
