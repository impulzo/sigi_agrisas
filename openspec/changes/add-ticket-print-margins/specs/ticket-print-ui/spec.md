...
- **THEN** the CSS `@page` rule declares `margin: 4mm 3mm` and the `.printable-ticket` container does not override with `top: 0 !important; left: 0 !important`, allowing the browser to apply the margins so content is not cut at paper edges
