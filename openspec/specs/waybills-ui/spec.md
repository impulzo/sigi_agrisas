...
Define the frontend for inter-branch merchandise transfers: listing, detail, creation (`simple` — no CFDI — or `carta_porte` — atomic CFDI stamping), and cancellation, under `/waybills`.
