...
Define el comportamiento de la interfaz de usuario de autenticación: páginas de login y registro, layout compartido split-panel, formularios con validación Zod, integración con los endpoints versionados `/api/v1/auth/*`, y tests unitarios de los bloques y la lógica del feature.
