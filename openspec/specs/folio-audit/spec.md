...
Define the backend endpoint and UI modal for auditing the document sequence issued under a given folio: detecting gaps, listing all issued documents, and handling truncated sequences exceeding 10 000 entries.
