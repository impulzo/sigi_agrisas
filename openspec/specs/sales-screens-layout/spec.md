# Spec: Sales Screens Layout

## Purpose

Define el gutter global de 10px (superior, izquierdo, derecho) del área de contenido de todas las pantallas del panel privado, aplicado desde el layout, y la prop `sizes` requerida en los logos de marca renderizados con `next/image` para eliminar el warning de consola. Consistencia de espaciado entre rutas privadas y login.
