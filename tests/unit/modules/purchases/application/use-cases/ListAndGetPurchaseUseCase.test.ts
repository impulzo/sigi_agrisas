...
function makeRepo(): InMemoryPurchaseRepository {
  ...
  repo.seedProvider({ id: PROVIDER_A, name: "Proveedor A", rfc: "AAA010101AAA", isActive: true, currentBalance: 0 });
  repo.seedProvider({ id: PROVIDER_B, name: "Proveedor B", rfc: "BBB010101AAA", isActive: true, currentBalance: 0 });
