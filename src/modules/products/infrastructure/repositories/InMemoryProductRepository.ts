...
export class InMemoryProductRepository implements ProductRepository {
  ...
  async update(id: string, data: UpdateProductData): Promise<ProductWithDepartment> {
    ...
    const updated = Product.create({
      ...
      manufactureDate: "manufactureDate" in data ? (data.manufactureDate ? new Date(data.manufactureDate) : null) : existing.manufactureDate,
      acquisitionPrice: "acquisitionPrice" in data ? data.acquisitionPrice ?? null : existing.acquisitionPrice,
